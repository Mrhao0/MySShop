    ...
    <div class="details w1200">
    	<div class="deta-info1">
        	...
        	<div class="dt-if1-m f-l">
            	<div class="dt-ifm-hd">
                	<h3><a href="#">${productInfmation.pname}</a></h3>
                	<p>${productInfmation.pDesced}</p>
                </div>
                <div class="dt-ifm-gojia">
                	<dl>
                        ...
                        <dd>
                        	<p class="p1">
                               <span class="sp1">${productInfmation.shopPrice}</span><span class="sp2">${productInfmation.marketPrice}</span>
                            </p>
                            <p class="p2">
                ...
                <dl class="dt-ifm-box3">
                    ...
                    <dd>
                        ...
                        <input type="number" onchange="numberChange()" id="numberId" value="1">
                    	<a class="box3-right" href="JavaScript:;">+</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <div class="dt-ifm-box4">
                	<button class="btn1"><a id="buy" href="#">立即购买</a></button>
                	<button class="btn2" name="injoinS" id="${productInfmation.pid}">加入购物车</button>
